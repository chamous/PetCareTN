...
var fbConfig			= require('./src/config/fb_authenticate');
var twitterConfig		= require('./src/config/twitter_authenticate');
...
var Pet 			= require('./src/models/Pet');
var Pet_Posting 	= require('./src/models/Pet_Posting');
var Sitter_Posting	= require('./src/models/Sitter_Posting');
var Report			= require('./src/models/Report');
var Review			= require('./src/models/Review');
var Pet_Review		= require('./src/models/Pet_Review');
var User			= require('./src/models/User');
var ForumPost		= require('./src/models/Forum_Post');
var Authentication  = require('./src/models/Authentication');

// Import Routes
var userRoute 			= require('./src/routes/user');
var petRoute 			= require('./src/routes/pet');
var applicationRoute 	= require('./src/routes/application');
var reportRoute 		= require('./src/routes/report');
var messageRoute 		= require('./src/routes/message');
var forumPostRoute 		= require('./src/routes/forum_post');
var petPostingRoute 	= require('./src/routes/pet_posting');
var sitterPostingRoute 	= require('./src/routes/sitter_posting');
var fileRoute			= require('./src/routes/file');
