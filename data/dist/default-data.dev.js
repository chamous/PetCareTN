...
var uristring = process.env.MONGOLAB_URI || process.env.MONGOHQ_URL || "mongodb://localhost/testDB";
var connection = mongoose.connect(uristring);
autoIncrement.initialize(connection); // Import Database schema

var Application = require(__dirname + '/../src/models/Application');

var Message = require(__dirname + '/../src/models/Message');

var Pet = require(__dirname + '/../src/models/Pet');

var Pet_Posting = require(__dirname + '/../src/models/Pet_Posting');

var Sitter_Posting = require(__dirname + '/../src/models/Sitter_Posting');

var Report = require(__dirname + '/../src/models/Report');

var Review = require(__dirname + '/../src/models/Review');

var Pet_Review = require(__dirname + '/../src/models/Pet_Review');

var User = require(__dirname + '/../src/models/User');

var ForumPost = require(__dirname + '/../src/models/Forum_Post');

var Authentication = require(__dirname + '/../src/models/Authentication'); // Drop all collections in the db
...
Authentication.collection.drop(); // Call functions in a series and at the end call process.exit()
...
async.series([function (callback) {
  ...
  // Adding report from userId=3 to userId=2
  ...
  // Adding report from userId=2 to userId=3
  var report = new Report({
    to: 3,
    from: 2,
  ...
  // Review from userId=3 to userId=2
  ...
  // Review from userId=2 to userId=3
  var review = new Review({
    to: 3,
    from: 2,
    rating: 4,
  ...
  // Pet Review from userId=3 to petId=1
  ...
  review.save(function (err, report) {
    ...
    Pet_Review.find({
      ...
      if (err) err;else {
        ...
        var newAvgRating = Math.round(sum / num); // Update new average rating on the pet schema
  ...
  // Pet Review from userId=3 to petId=2
  var review = new Pet_Review({
    to: 2,
    // petId=2
    from: 3,
  ...
  // Pet Review from userId=2 to petId=3
  var review = new Pet_Review({
    to: 3,
    // petId=3
    from: 2,
  ...
  // Pet Review from userId=2 to petId=4
  var review = new Pet_Review({
    to: 4,
    // petId=4
    from: 2,
  ...
  // Adding pet posting userId = 2, petId = 1
  ...
  // Adding pet posting userId = 2, petId = 2
  var pet_posting = new Pet_Posting({
    _id: 4,
    user: 2,
    pet: 2,
  ...
  // Adding pet posting userId = 3, petId = 3
  var pet_posting = new Pet_Posting({
    _id: 6,
    user: 3,
    pet: 3,
  ...
  // Adding pet posting userId = 3, petId = 4
  var pet_posting = new Pet_Posting({
    _id: 9,
    user: 3,
    pet: 4,
  ...
  // Adding sitter posting userId = 1
  ...
  // Adding sitter posting userId = 2
  var sitter_posting = new Sitter_Posting({
    _id: 3,
    user: 2,
  ...
  // Adding sitter posting userId = 3
  var sitter_posting = new Sitter_Posting({
    _id: 8,
    user: 3,
  ...
  // Adding application from userId 1 to userId 2
  ...
  // Adding application from userId 1 to userId 3
  var application = new Application({
    to: 3,
    from: 1,
    isPetPost: false,
  ...
  // Adding application from userId 2 to userId 1
  var application = new Application({
    to: 1,
    from: 2,
    isPetPost: false,
  ...
  // Adding application from userId 2 to userId 3
  var application = new Application({
    to: 3,
    from: 2,
    isPetPost: true,
  ...
  // Adding message from userId 2 to userId 1
  ...
  // Adding message from userId 1 to userId 2
  var meessage = new Message({
    to: 2,
    from: 1,
  ...
  // Adding message from userId 1 to userId 3
  var meessage = new Message({
    to: 3,
    from: 1,
